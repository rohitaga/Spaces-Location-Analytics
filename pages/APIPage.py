...
def show():
    ...
    Each section includes methods associated with the activity type, including examples. Browse our API below and click to learn more about any of our available commands! 🎈
    """)
    ...
    st.write("""
    Check out some of our favorite apps created by Streamlit users and hosted on Streamlit Community Cloud.
